...
abstract class VideoPlayerPlatform extends PlatformInterface {
  ...
  Future<PlayerTracks> getTracks(int textureId) {
    throw UnimplementedError('getAudioTracks() has not been implemented.');
  }

  Future<void> setTrack(int textureId, int group, int formatIndex) {
    throw UnimplementedError('getAudioTracks() has not been implemented.');
  }
  ...
  /// Gets the video position as [Duration] from the start.
  Future<String> getCurrentSubtitle(int textureId) {
    throw UnimplementedError('getPosition() has not been implemented.');
  }
...
/// [PlayerTrackFormat] can be audio, video or text track
@immutable
class PlayerTrackFormat {
  /// [PlayerTrackFormat] can be audio, video or text track
  const PlayerTrackFormat({
    required this.id,
    required this.label,
...
/// [PlayerTrackGroup] can be audio, video or text track
@immutable
class PlayerTrackGroup {
  /// [PlayerTrackGroup] can be audio, video or text track
  const PlayerTrackGroup({
    required this.adaptiveSupported,
    required this.trackSelected,
    required this.trackSupported,
    required this.formats,
    required this.trackType,
    required this.index,
  });
  final bool adaptiveSupported;
  final List<bool>? trackSelected;
  final List<bool>? trackSupported;
  final List<PlayerTrackFormat> formats;
  final TrackType trackType;
  final int index;
}

/// [PlayerTracks] can be audio, video or text track
@immutable
class PlayerTracks {
  /// [PlayerTracks] can be audio, video or text track
  const PlayerTracks({
  ...
  final List<PlayerTrackGroup?> groups;
}
